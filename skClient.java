 ...
 */
    ...
    skTab addTab(String name, int lid) {
        
        
        skTab tb=new skTab(this, out, skMyNick, skTabbedPane, skUserListModel, skChatListModel);
    ...
    private skTab findTab(javax.swing.JSplitPane splitpane) {
        skTab ltab=null;
        for (Iterator i=tabList.iterator();i.hasNext();){
            ltab=(skTab)i.next();
